...
<html>
   ...
   <script type="text/javascript">
      ...
      function encrypt_function(iframe_content){
        
        var encrypt_url = $("#url").val();
        var encrypt_message1 = $("#message1").val();
        var encrypt_facebook_url = $("#facebook-url").val();
        var encrypt_cta = $("#cta").val();
        ...
        $.ajax({
          url: "encrypt.php",
          type: "post",
          data: {encrypt_extension:encodeURI(encrypt_param)},
          success: function (response) {
           // you will get response from your php page (what you echo or print)  
           console.log(response);
           $("#encrypt-content").val(response);
          },
              ...
              $.ajax({
                ...
                console.log(data);       
                  if(data.hasOwnProperty("ampUrls")){
                    ...
                    $("#iframe-type").val("amp");
                    encrypt_function(data.ampUrls[0].cdnAmpUrl);
